...
<body>
    ...
    <div class = "container-fluid">
	    <form method = "post" action = "FactoryMainMachine4_History">
	      	<div class = "row">      	
		...
		<div class = "col-sm-12" align = "center"><h3>Machine 4</h3></div>
...
function plotPDFTemperature() {
	...
	$.plot($("#pdf-temperature"),[ data, sp, lsl, usl ],{
	    series: {
		    lines: {
				show: true,
				align: "center"
...
function plotPDFPressure() {
	...
	$.plot($("#pdf-pressure"),[ data, sp, lsl, usl ],{
	    series: {
		    lines: {
				show: true,
				align: "center"
...
function plotPDFFlowRate() {
	...
	$.plot($("#pdf-flowrate"),[ data, sp, lsl, usl ],{
	    series: {
		    lines: {
				show: true,
				align: "center"
